...
/// @nodoc
abstract class _$$_HackathonStateCopyWith<$Res>
    implements $HackathonStateCopyWith<$Res> {
...
/// @nodoc
class __$$_HackathonStateCopyWithImpl<$Res>
    extends _$HackathonStateCopyWithImpl<$Res, _$_HackathonState>
    implements _$$_HackathonStateCopyWith<$Res> {
  __$$_HackathonStateCopyWithImpl(
      _$_HackathonState _value, $Res Function(_$_HackathonState) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_HackathonState(
      hackathons: null == hackathons
          ? _value._hackathons
          : hackathons // ignore: cast_nullable_to_non_nullable
              as List<HackathonModel>,
...
/// @nodoc
@JsonSerializable()
class _$_HackathonState implements _HackathonState {
  const _$_HackathonState(
      {final List<HackathonModel> hackathons = const [],
      this.isLoading = false})
      : _hackathons = hackathons;

  factory _$_HackathonState.fromJson(Map<String, dynamic> json) =>
  ...
  _$$_HackathonStateCopyWith<_$_HackathonState> get copyWith =>
      __$$_HackathonStateCopyWithImpl<_$_HackathonState>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_HackathonStateToJson(
      this,
    );
  }
}
...
abstract class _HackathonState implements HackathonState {
  const factory _HackathonState(
      ...
      final bool isLoading}) = _$_HackathonState;

  factory _HackathonState.fromJson(Map<String, dynamic> json) =
      _$_HackathonState.fromJson;
